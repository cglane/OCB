...
DEBUG = True
SECRET_KEY = 'blahd*04ah_y2^6=h3t85)@9x++@pz_78p-*mm!i$(1f=fzs9)0r+fbar'
GOOGLE_CLOUD_PROJECT='brave-standard-180615'
SQL_DEBUG = DEBUG
TEMPLATE_DEBUG = DEBUG
FONTAWESOME_CSS_URL = 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css'

ALLOWED_HOSTS = ['backend-dot-brave-standard-180615.appspot.com','www.originalcharlestonbedswing.com', 'localhost', 'originalcharlestonbedswing.com', 'storage.googleapis.com']
...
if DEBUG == False:
  STRIPE_SECRET_KEY = 'sk_live_BAtaT45LRzkeah0QMie5kaGD'
  STRIPE_PUBLIC_KEY = 'pk_live_KvtGdIc7BMAhRJUOi1rOu9PL'
else:
...
DATABASES['default']['HOST'] = '/cloudsql/brave-standard-180615:us-east1:bedswing'
...
MEDIA_URL = 'http://storage.googleapis.com/bedswing-bucket/media/'

if DEBUG == True:
  STATIC_URL = '/public/static/'
else:
  STATIC_URL = 'https://storage.googleapis.com/bedswing-bucket/static/'
...
###Save Files on Google Bucket
DEFAULT_FILE_STORAGE = 'storages.backends.gcloud.GoogleCloudStorage'
GS_BUCKET_NAME = 'bedswing-bucket'
GS_PROJECT_ID = '40268175115'
...
GOOGLE_APPLICATION_CREDENTIALS="~/Destop/Django-Bedswing/Test-Google-9c30bb2df3c2.json"
